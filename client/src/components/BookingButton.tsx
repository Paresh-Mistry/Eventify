  ...
  return (
    <>
      ...
      >
        {status === "loading"
          ? "Booking..."
          : `Enroll In ${eventTitle.split(" ")[0]} Indiviually`}
      </button>
      ...
      {status === "error" && (
        <p className="text-red-600 mt-2">Booking failed. Try again.</p>
      )}

      {showRules && (
        <div className="fixed inset-3 bg-opacity-50 backdrop-blur-xs flex justify-center items-center z-50">
          <div className="bg-white rounded-lg p-6 w-96 max-w-full mx-4">
            <h2 className="text-2xl m-4 underline underline-offset-2">
              Rules & Regulation
            </h2>
