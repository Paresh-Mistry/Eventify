        ...
        <div className='flex md:flex-row flex-col w-full gap-3 items-start flex-grow max-w-7xl mx-auto'>
            <div className="md:w-3/4 w-full py-3 bg-gray-100">
                ...
                <div className="px-3 mb-3 relative">
                    <Image
                        src={event.banner_image ? `http://localhost:8000/${event.banner_image}` : image}
                    ...
                    <div className='absolute right-10 bottom-10'>
                        <h1 className='text-2xl md:text-6xl font-extrabold text-gray-800'>{event.title}</h1>
                    </div>
                </div>
                ...
                <div className="px-4 py-2 bg-white rounded-xl shadow-sm mx-2 border border-gray-200 text-sm text-gray-700 font-medium flex items-center justify-between">
                    <span className="text-gray-600">Free | Event Mode:</span>
                    <span className={`px-2 py-1 rounded-full text-xs font-semibold ${event.is_online ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
            ...
            <div className="w-full md:w-1/4 bg-white rounded-2xl shadow-lg my-4 p-6 border border-gray-200 transition-all duration-300 hover:shadow-xl">
                <h3 className="text-2xl font-semibold text-blue-800 mb-5 border-b border-gray-300 pb-2">
                    Event Details
                </h3>

                <div className="space-y-4 text-gray-700 text-sm">
                    <div className='border-l-4 px-2 border-blue-800 rounded'>
