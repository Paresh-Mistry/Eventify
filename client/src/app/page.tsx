  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-24 px-4 text-center">
        ...
        <Link
          href={"/Events"}
          className="bg-blue-400 shadow-md text-white rounded-2xl px-6 py-2 transition"
        >
          Explore Events
        </Link>
      </section>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div>
              ...
              <p className="text-gray-600">
                Create, manage, and sell tickets with just a few clicks.
              </p>
            </div>
            <div>
              ...
              <p className="text-gray-600">
                Track registrations and sales in real time.
              </p>
            </div>
            <div>
              ...
              <p className="text-gray-600">
                Keep attendees updated with automated alerts.
              </p>
            </div>
          </div>
        </div>
