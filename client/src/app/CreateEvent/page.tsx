            ...
            >
                    ...
                    <div className='flex md:flex-row pb-4 flex-col w-full gap-6'>
                        <div className='md:w-5/12 space-y-8'>
                            ...
                            <div className="flex items-center space-x-2">
                                ...
                                />
                                <label className="font-medium text-gray-700">Online Event</label>
                            </div>
                        </div>
                ...
                {step === 3 && (
                    <div className='flex md:flex-row flex-col w-full gap-6'>
                        ...
                        <div className='md:w-1/2 space-y-6'>
                            <div>
                                <label className="block mb-1 font-semibold text-gray-700">Event Date</label>
                                <input
                                    type="date"
                                    name="date"
                                    value={formData.date}
                        ...
                        <div className='md:w-1/2'>
                            <label className="block mb-1 font-semibold text-gray-700">File/Image Upload</label>

                            <div className="flex items-center justify-center w-full">
                                <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-64 border-2 border-dashed rounded-xl cursor-pointer bg-white hover:bg-gray-50 border-gray-300 transition-all duration-300 shadow-sm">
                                    <div className="flex flex-col items-center justify-center pt-5 pb-6">
                                        <svg className="w-10 h-10 mb-3 text-blue-500" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M16 16l-4-4-4 4m4-4v9M4 4h16" />
                                        </svg>
                                        <p className="mb-1 text-sm text-gray-600"><span className="font-semibold">Click to upload</span> or drag & drop</p>
                                        <p className="text-xs text-gray-400">SVG, PNG, JPG or GIF (Max 800x400px)</p>
                                        {formData.bannerImage && (
                                            <p className="mt-3 text-sm text-green-600 font-medium">{formData.bannerImage.name}</p>
                                        )}
                                    </div>
                                    <input
                                        id="dropzone-file"
                ...
                {step == 1 ? "" : <div className="flex justify-between my-6">
                    <button
                        ...
                        onClick={prevStep}
                        disabled={step === 1}
                        className={`px-4 py-2 border rounded ${step === 1
                            ? 'cursor-not-allowed'
                            : 'hover:bg-gray-200'
                            }`}
                    >
