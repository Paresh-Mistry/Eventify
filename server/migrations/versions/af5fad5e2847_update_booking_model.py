...
Revision ID: af5fad5e2847
Revises: b29aa64db4f5
Create Date: 2025-09-13 15:58:13.382006
...
revision: str = 'af5fad5e2847'
down_revision: Union[str, Sequence[str], None] = 'b29aa64db4f5'
...
def downgrade() -> None:
    ...
    sa.Column('event_id', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['event_id'], ['events.id'], name=op.f('faqs_event_id_fkey')),
    ...
    op.create_index(op.f('ix_events_email'), 'events', ['email'], unique=False)
    # ### end Alembic commands ###
